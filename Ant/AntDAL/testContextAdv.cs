...
replace(STRING_AGG(cast(c.searchCriteria as varchar(max)),'!') ,'!!','') as SearchCriteria, c.CountryName as Name, count(ca.ID)as NumberAuthors,c.idHDCountry  as IdParent 
