...
namespace AntBL
{
    public class Period
    {
        ...
        public async Task<FindBetweenResult[]> FindAdvanced(string idTopic, string idSpec,string idLitMov,string idProf)
        {


            return await t.FindAdvanced(idTopic,idSpec,idLitMov,idProf);
